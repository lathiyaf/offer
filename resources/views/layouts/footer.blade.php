            ...
            <div class="Polaris-FooterHelp__Content">
                ...
                <div class="Polaris-FooterHelp__Text">Learn more about <a class="Polaris-Link" href="https://help.shopify.com/manual/orders/fulfill-orders" data-polaris-unstyled="true">{{ config('shopify-app.app_name')  }}</a></div>
            </div>
        </div>
