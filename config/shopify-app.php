...
return [
    ...
    */
    ...
    'shop_model' => env('SHOPIFY_SHOP_MODEL', '\App\Models\Shop'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_draft_orders,read_draft_orders,read_themes,write_themes,read_script_tags,write_script_tags,read_products,write_products,read_orders,write_orders'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            'topic' => 'orders/delete',
            'address' => env('APP_URL').'/webhook/orders-delete'
        ],
        [
            'topic' => 'shop/update',
